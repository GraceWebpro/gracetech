...
const Terms = () => {
  return (
    <main style={{
    ...
    }}className="max-w-4xl mx-auto px-6 py-12 text-gray-800 leading-relaxed">
      <Helmet>
      ...
      <h3 style={{ textAlign: "left", marginTop: "20px" }} className="text-2xl font-semibold mb-2">1. Use of Our Website</h3>
      <p className="mb-4">
      ...
      <h3 style={{ textAlign: "left", marginTop: "20px" }} className="text-2xl font-semibold mb-2">2. Intellectual Property</h3>
      <p className="mb-4">
      ...
      <h3 style={{ textAlign: "left", marginTop: "20px" }} className="text-2xl font-semibold mb-2">3. Limitation of Liability</h3>
      <p className="mb-4">
      ...
      <h3 style={{ textAlign: "left", marginTop: "20px" }} className="text-2xl font-semibold mb-2">4. External Links</h3>
      <p className="mb-4">
      ...
      <h3 style={{ textAlign: "left", marginTop: "20px" }} className="text-2xl font-semibold mb-2">5. Changes to Terms</h3>
      <p className="mb-4">
