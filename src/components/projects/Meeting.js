    ...
    <div className='meeting'>
        <div className='meet-left'>
            <div className='proj-h' style={{ display: 'flex', gap: '20px', alignItems: 'center', justifyContent:'center' }} data-aos="fade-down">
                ...
                <h2 style={{ textAlign: 'center', fontFamily: 'Dancing Script, "sans-seriff"', color: '#0059ff' }}><em>Need a Project?</em></h2>
            ...
            <div className='exp-div-display'>
                ...
                <div className='skill-div' data-aos="fade-left" data-aos-duration="500">
