...
const ProjectCard = ({project}) => {
  ...
  return (
    <div className='group relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300 flex flex-col'>
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-80 transition-opacity duration-300" />
      ...
      <div className="p-6 space-y-4 flex flex-col flex-1">
        <div>
          <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-[#a3ff8d] transition-colors duration-300">
            {title}
          </h3>
