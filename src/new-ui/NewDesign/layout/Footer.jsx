        ...
        <footer className="footer">
          ...
          <div className="footer-content">
              ...
              <div className="footer-content-column">
                ...
                <div className="footer-menu">
                  ...
                  <div className="space-y-3">
                    <a href='mailto:gogracetech@gmail.com' className="group flex items-center gap-3 px-3 transition-all duration-300">
                    ...
                    <ul className="space-y-3">
                      {NAV_LINKS.map((link) => (
                        <li key={link.id}>
                          ...
                          >
                            <div className="w-1.5 h-1.5 rounded-full bg-white/0 group-hover:bg-primary group-hover:w-2 transition-all duration-300" />
            ...
            <div className="footer-social-links"> 
              ...
              <a className="footer-social-link linkedin" href="linkedIn" target="_blank">
              ...
              <a className="footer-social-link twitter" href="twitter" target="_blank">
              ...
              <a className="footer-social-link youtube" href="youtube" target="_blank">
              ...
              <a className="footer-social-link github" href="github" target="_blank">
